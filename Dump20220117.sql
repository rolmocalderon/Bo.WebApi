...
CREATE TABLE `pickups` (
  ...
  CONSTRAINT `placeId` FOREIGN KEY (`placeId`) REFERENCES `places` (`id`)
...
INSERT INTO `pickups` VALUES (1,'17/1/2022',1,15,NULL,1),(2,'16/1/2022',2,12,NULL,1),(3,'15/1/2022',3,15,NULL,2),(4,'15/1/2022',2,3,NULL,2);
...
INSERT INTO `places` VALUES (1,'Mercadona nou barris'),(2,'Bon Preu Sant Andreu');
...
-- Dump completed on 2022-01-17 22:24:25
